...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    #define LV_MEM_SIZE (8 * 1024 * 1024)   /* 8 MB: two ARGB canvases + draw tasks */
...
#define LV_USE_ASSERT_STYLE         0   /**< Disabled: style sanity checks use more RAM */
#define LV_USE_ASSERT_MEM_INTEGRITY 0   /**< Disabled: memory integrity checks make LVGL much slower */
#define LV_USE_ASSERT_OBJ           0   /**< Disabled: object sanity checks make LVGL much slower */
...
#ifndef IHM_LV_USE_SDL
    #define IHM_LV_USE_SDL 1
#endif
#define LV_USE_SDL              IHM_LV_USE_SDL
#if LV_USE_SDL
...
/** Driver for /dev/fb */
#ifndef IHM_LV_USE_LINUX_FBDEV
    #define IHM_LV_USE_LINUX_FBDEV 0
#endif
#define LV_USE_LINUX_FBDEV      IHM_LV_USE_LINUX_FBDEV
...
#ifndef IHM_LV_USE_LINUX_DRM
    #define IHM_LV_USE_LINUX_DRM 0
#endif
#define LV_USE_LINUX_DRM        IHM_LV_USE_LINUX_DRM
...
#ifndef IHM_LV_USE_EVDEV
    #define IHM_LV_USE_EVDEV 0
#endif
#define LV_USE_EVDEV    IHM_LV_USE_EVDEV
